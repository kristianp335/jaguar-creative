...
<#if show_dockbar>
	<section class="container-fluid-wide" id="breadcrumbs" style="margin-top: 153px;">
</#if>
<#if !show_dockbar>
	<section class="container-fluid-wide" id="breadcrumbs" style="margin-top: 92px;">
</#if>
		<div class="container-fluid-1280">		
			<#assign preferences = freeMarkerPortletPreferences.getPreferences("portletSetupPortletDecoratorId", "barebone") />
			<@liferay_portlet["runtime"] defaultPreferences=preferences portletProviderAction=portletProviderAction.VIEW instanceId="anynameyoucangive" portletName="com_liferay_site_navigation_breadcrumb_web_portlet_SiteNavigationBreadcrumbPortlet" />
		</div>
	</section>
<#if show_dockbar>
